...
import io.legado.app.mcp.McpServer;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        io.legado.app.skills.SkillManager.getInstance().init(this);
        final String skillsPath = io.legado.app.skills.SkillManager.getInstance().getRuntimeSkillsPath();
        if (skillsPath != null) {
