...
public class FilePathResolver {
    ...
    private static final String BASE_DIR = "/data/data/io.legado.app/files";
    private static final String EXT_STORAGE = "/storage/emulated/0";
    private static final String APP_EXTERNAL = "/storage/emulated/0/Android/data/io.legado.app/files";
