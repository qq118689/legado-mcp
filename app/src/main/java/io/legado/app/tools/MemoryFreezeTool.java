...
import io.legado.app.gm.MemoryEngine;
import io.legado.app.gm.MemoryFreezer;
import org.json.JSONObject;

public class MemoryFreezeTool implements Tool {

    @Override
    public String getName() {
        return "gm_memory_freeze";
    }

    @Override
    public String getDescription() {
        return "冻结指定内存地址的数值（需要Root权限）";
    }
    ...
    public JSONObject getInputSchema() {
        try {
            ...
            properties.put("value", new JSONObject().put("type", "string").put("description", "要冻结的数值"));
